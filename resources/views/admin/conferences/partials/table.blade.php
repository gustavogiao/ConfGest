...
<table class="min-w-full border border-gray-300 dark:border-gray-700 rounded-lg overflow-hidden">
    ...
    @forelse($conferences as $conference)
        @include('admin.conferences.partials.row', ['conference' => $conference])
    @empty
        <tr>
            <td colspan="5" class="px-4 py-3 text-center text-gray-500 dark:text-gray-400">No conferences found.</td>
        </tr>
    @endforelse
    </tbody>
</table>
