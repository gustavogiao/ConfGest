            ...
            <div class="px-4">
                ...
                @else
                    <a href="{{ route('register') }}"
                       class="font-medium text-base text-white bg-indigo-500 px-3 py-1 rounded hover:bg-indigo-600 transition block mb-1">
                        Registar
                    </a>
                    <div class="font-medium text-sm text-gray-500">Sem email</div>
                @endif
